...
const freeTabs = [{ label: "Plans", href: "/subscription", icon: Package }];
...
export function Subscription() {
  ...
  return <PageShell title="Subscription" description="Manage your plan, invoices, and billing details." tabs={tabs} />;
}
